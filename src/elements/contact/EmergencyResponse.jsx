...
class EmergencyResponse extends Component{
    constructor(props){
        ...
        this.onChangeResponseFullName = this.onChangeResponseFullName.bind(this);
        this.onChangeResponseWorkEmail = this.onChangeResponseWorkEmail.bind(this);
        this.onChangeResponsePhone = this.onChangeResponsePhone.bind(this);
        this.onChangeResponseOrganisation = this.onChangeResponseOrganisation.bind(this);
        this.onChangeResponseJobRole = this.onChangeResponseJobRole.bind(this);
        this.onChangeResponseHelp = this.onChangeResponseHelp.bind(this);
        this.onChangeResponseCompanySize = this.onChangeResponseCompanySize.bind(this);
        ...
        onChangeResponseFullName(e) {
            this.setState({fullname: e.target.value})
          }
        
        onChangeResponseWorkEmail(e) {
            this.setState({workemail: e.target.value})
          }
        
        onChangeResponsePhone(e) {
            this.setState({phone: e.target.value})
          }
    
        onChangeResponseOrganisation(e) {
            this.setState({organisation: e.target.value})
          }
        onChangeResponseJobRole(e) {
            this.setState({jobrole: e.target.value})
          }
        
        onChangeResponseHelp(e) {
            this.setState({help: e.target.value})
          }
    
        onChangeResponseCompanySize(e) {
         ...
         // }
          onSubmit(e) {
            ...
            companysize:this.state.companysize
             ...
             axios.post('http://localhost:8000/api/emergency/',learning,{
                                ...
                                <form onSubmit={this.onSubmit}>
                                    <label htmlFor="item01">
                                        <input
                                            ...
                                            onChange={this.onChangeResponseFullName}
                                    ...
                                    <label htmlFor="item02">
                                        <input
                                            ...
                                            onChange={this.onChangeResponseWorkEmail}
                                    ...
                                    <label htmlFor="item03">
                                        ...
                                        <input
                                            ...
                                            onChange={this.onChangeResponsePhone}
                                    ...
                                    <label htmlFor="item04">
                                        <input
                                            ...
                                            onChange={this.onChangeResponseOrganisation}
                                            placeholder="Your Organisation"
                                        />
                                    </label>
                                    <label htmlFor="item05">
                                        Job Role
                                    <select value={this.state.jobrole} onChange={this.onChangeResponseJobRole}>
                            ...
                            <option value="Others">Others</option>
                                    ...
                                    <label htmlFor="item06">
                                        <input
                                            ...
                                            onChange={this.onChangeResponseHelp}
                                            placeholder="How else can we be of help? *"
                                        />
                                    </label>
                                    <label htmlFor="item07">
                                        Company Size
                                    <select value={this.state.companysize} onChange={this.onChangeResponseCompanySize}>
