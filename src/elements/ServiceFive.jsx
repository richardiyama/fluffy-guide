    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                ...
                <div className="breadcrumb-area rn-bg-color ptb--120 pg_image facilitymanagement">
                    ...
                    <div className="container">
                        ...
                        <div className="rn-columns-area ptb--120 bg_color--1">
                            <div className="container">
                                ...
                                <a className="rn-button-style--2 btn-solid" href="/schedule_facility_management">Schedule A Consultation Now</a>
                            </div>
                            </div>
                        </div>
                        {/* Start Columns Area  */}
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center mb--30">
                                    <h2>All our {this.state.title}</h2>
