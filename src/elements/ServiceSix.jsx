...
class ServiceSix extends Component {
    ...
    CourseList(){
        axios.get('http://eaz-roc.ng/api/coursefiles/').then(res => res.data)
        .then(res => {
            this.setState({
                course: res.data
            });
            ...
            <React.Fragment>
                ...
                <div className="service-area ptb--120 bg_color--5">
                    ...
                    <div className="container">
                        ...
                        <div className="section-title text-center mb--30">
                            <h3>Are you looking for a training company that will help you;</h3>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" key={serve.id}>
                                    ...
                                    <div className="service service__style--2">
                                        ...
                                        <div className="content">
                                            <h4 className="title">{serve.title}</h4>
                        ...
                        <div className="row service-one-wrapper">
                            <div className="about-button mt--50  col-md-6">
                                <a className="rn-button-style--2 btn-solid" href="/schedule_learning_development">Schedule A Consultation</a>
                            </div>
                            {this.state.course.map( coursefile =>
                            <div className="about-button mt--50  col-md-6">
                                <a className="rn-button-style--2 btn-solid" href={`http://eaz-roc.ng/images/course/${coursefile.course_file_image}`}>Explore Courses</a>
                            </div>
                            )}
                        </div>
