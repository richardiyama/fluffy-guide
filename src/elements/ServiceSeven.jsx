...
class ServiceSeven extends Component {
            ...
            <React.Fragment>
                ...
                <div className="service-area ptb--120 bg_color--5">
                    ...
                    <div className="container">
                        ...
                        <div className="section-title text-center mb--30">
                            <h3>Are you renting out a property? Check your future tenants.</h3>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" key={serve.id}>
                                    ...
                                    <div className="service service__style--2">
                                        ...
                                        <div className="content">
                                            ...
                                            <a className="btn-transparent rn-btn-dark" href="#"><span className="text">Schedule A Free Consultation Now</span></a>
                                        </div>
                                    </div>
                        ...
                        <div className="about-button mt--50  col-md-6">
                                <a className="rn-button-style--2 btn-solid" href="/schedule_background">Schedule A Consultation Now</a>
                            </div>
                    </div>
                </div>
                {/* End Service Area */}
