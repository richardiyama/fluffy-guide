    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                ...
                <div className="breadcrumb-area rn-bg-color ptb--120 pg_image HrOutsourcing">
                    ...
                    <div className="container">
                        ...
                        <div className="rn-columns-area ptb--120 bg_color--1">
                            <div className="container">
                                ...
                                <a className="rn-button-style--2 btn-solid" href="/schedule_hr_outsourcing">Schedule A Consultation Now</a>
                            </div>
                            </div>
                        </div>
                        {/* Start Columns Area  */}
