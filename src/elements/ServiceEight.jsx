...
class ServiceEight extends Component {
            ...
            <React.Fragment>
                ...
                <div className="service-area ptb--120 bg_color--5">
                    ...
                    <div className="container">
                        ...
                        <div className="section-title text-center mb--30">
                            <h3>Are you looking for a recruitment agency that will help you;</h3>
                        ...
                        <div className="about-button mt--50  col-md-6">
                                <a className="rn-button-style--2 btn-solid" href="/schedule_recuitment">Schedule A Consultation</a>
                            </div>
                    </div>
                </div>
                {/* End Service Area */}
